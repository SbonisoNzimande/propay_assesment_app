...
<head>
	...
	<title>Person Management System | Login</title>
	...
	<!-- Animate.css -->
	<link href="public/template/vendors/animate.css/animate.min.css" rel="stylesheet">
...
<body class="login" ng-app="PersonApp">
	<div>
